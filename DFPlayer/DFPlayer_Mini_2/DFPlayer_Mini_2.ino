...
#define CARD1_UID "B3 2D 0D F8"
#define CARD2_UID "B3 8C F4 1C"
...
void setup() {
  ...
  myDFPlayer.volume(10); // Volum 0-30
...
void loop() {
  ...
  if (currentCard == CARD1_UID) {
    Serial.println(F("-> Targeta 1 reconeguda!"));
    myDFPlayer.play(1); // Reproduir arxiu 0001.mp3
  }
  else if (currentCard == CARD2_UID) {
    Serial.println(F("-> Targeta 2 reconeguda!"));
    myDFPlayer.play(2); // Reproduir arxiu 0002.mp3
  }
  else {
